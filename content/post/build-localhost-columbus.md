---
layout: post
title: "Bringing Build Home in Columbus"
date: 2026-07-01
categories: ["Microsoft Build"]
author: "Michael S. Collier"
tags: [microsoft-build, azure, github-copilot, agents, community]
comments: true
---

Microsoft Build is always packed with big announcements, but my favorite part is bringing those ideas back home and figuring out what actually helps teams ship better software. On June 20th, we did exactly that at [**Microsoft Build \\\\localhost:columbus**](https://developer.microsoft.com/en-us/reactor/events/27247/).

<!--more-->

Hosted at the Improving Columbus office, the event drew nearly 20 attendees and had the engery I enjoy about smaller, local tech events - practical, curious, supportive, and the opportunity to "geek out" and meet new folks. The event was sponsored by [Microsoft Azure Tech Groups](https://developer.microsoft.com/en-us/azure-tech-groups/overview), and I appreciated their support in helping make it happen.
...
![Picture from event showing several people around tables listening to a presentation](/images/build-localhost-columbus/localhost-build-image1.jpg)

## Grateful for great partners

I had the pleasure of organizing this with three outstanding local tech leaders: [Drake Lundstrom](https://www.linkedin.com/in/drake-lundstrom/), [Matt Eland](https://www.linkedin.com/in/matteland/), and [Alan Barber](https://www.linkedin.com/in/alanbarber/) (both Drake and Matt as Microsoft MVPs).  This was a great collaboration between the [Azure Columbus](https://www.meetup.com/central-ohio-azure/) and [Central Ohio .NET Developers](https://www.meetup.com/central-ohio-net-developers-group-condg/) groups.
...
I presented **"From CLI to PR: Automating the path to merged code"**. If you want the original Build session, you can watch it here: [From CLI to PR: Automating the path to merged code](https://build.microsoft.com/en-US/sessions/BRK203)
...
1. AI-assisted engineering still needs strong human review.
2. Agentic software engineering patterns are becoming practical for real teams.
3. Local events create better Q&A, better networking, and better learning.
