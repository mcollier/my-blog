...
- [Future of Developer Productivity: Microsoft’s EngThrive Framework in Practice](https://build.microsoft.com/en-US/sessions/BRK210): This was one of the better sessions I attended at Build.  I found it really interesting to learn how Microsoft's engineering teams have approached using AI and how they're measured on outcomes/value instead of activity.  I'd had similar conversations in my firm about how to measure value and using AI engineering tools to deliver better outcomes.  I've also had conversations about "token maxing" and, in my opinion, the problems that presents.
